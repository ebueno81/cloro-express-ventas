...
Public Class Cls_BolAnexo
    Dim Conexion As New Cls_Conexion
    Dim Conex As New OleDbConnection(Conexion.GetConexion_Sql)
    Dim cmd As New OleDbCommand
    Public Function sca_BolAnexo_SAVE(ByVal ent As Ent_BolAnexo) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Sca_upt_BolAnexo"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_total_boleta", OleDbType.Decimal, 10, 2).Value = ent.c_total_boleta
            cmd.Parameters.Add("@c_serie_anexo", OleDbType.VarChar, 5).Value = ent.c_serie_anexo
            cmd.Parameters.Add("@c_boleta_anexo", OleDbType.VarChar, 10).Value = ent.c_boleta_anexo
        ...
        Return Codigo
    End Function
    Public Function Sca_BolAnexo_Datos(ByVal Cadena As String, ByVal vOpt As String) As DataTable
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Sca_Datos_BolAnexo"
