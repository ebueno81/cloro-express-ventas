...
Public Class Cls_FactGuia
    ...
    Public Function Get_FactGuia_Datos(ByVal Cadena As String, ByVal vOpt As String, ByVal Emp As String) As DataTable
        ...
        cmd.CommandText = "Sp_Sca_Datos_FactGuia"
        ...
        Return Tabla
    End Function
    Public Function sca_FactGuia_Save(ByVal ent As Ent_FactGuia, ByVal Emp As String) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Sca_Fa_upt_FactGuia"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_serie_factura", OleDbType.VarChar, 5).Value = ent.c_serie_factura
