...
Public Class Cls_FactElectDet
    ...
    Public Function Get_FactElectDet_Datos(ByVal Cadena As String, ByVal vOpt As String) As DataTable
        ...
        cmd.CommandText = "Sp_Sca_Datos_FactElectDet"
        ...
        Return Tabla
    End Function
    Public Function sca_FactElectDet_Save(ByVal c_nro_serie As String, ByVal c_nro_factura As String, ByVal c_codi_doc As String,
                                          ByVal vOpt As String) As Boolean
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Sca_upt_FactElectDet"
