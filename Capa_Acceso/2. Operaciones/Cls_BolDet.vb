...
Public Class Cls_BolDet
    Dim Conexion As New Cls_Conexion
    Dim Conex As New OleDbConnection(Conexion.GetConexion_Sql)
    Dim cmd As New OleDbCommand
    Public Function sca_BolDet_Save(ByVal ent As Ent_BolDet, ByVal Emp As String) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "sp_Sca_Fa_upt_BolDet"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_nro_cant", OleDbType.Numeric, 9, 2).Value = ent.c_nro_cant
            cmd.Parameters.Add("@c_precio_venta", OleDbType.Numeric, 9, 4).Value = ent.c_prec_venta
            cmd.Parameters.Add("@c_total_bol", OleDbType.Numeric, 15, 2).Value = ent.c_total_bol
    ...
    Public Function Get_BolDet_Datos(ByVal Cadena As String, ByVal vOpt As String, ByVal Emp As String) As DataTable
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Sca_Datos_BolDet"
