...
Public Class Cls_NotaC
    ...
    Public Function sca_NotaC_SAVE(ByVal ent As Ent_NotaC, ByVal Emp As String) As String
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
        cmd.CommandText = "Sp_Sca_Fa_upt_NotaC"
        ...
        Try
            ...
            cmd.Parameters.Add("@c_nro_nc", OleDbType.VarChar, 10).Value = ent.c_nro_nc
            ...
            cmd.Parameters.Add("@c_total_doc", OleDbType.Numeric, 10, 2).Value = ent.c_total_doc
            cmd.Parameters.Add("@c_imp_nc", OleDbType.Numeric, 10, 2).Value = ent.c_imp_nc
            ...
            cmd.Parameters.Add("@c_motivo_nc", OleDbType.VarChar, 3000).Value = ent.c_motivo_nc
            cmd.Parameters.Add("@c_letras_nc", OleDbType.VarChar, 150).Value = ent.c_letras_nc
        ...
        Return Codigo
    End Function
    Public Function Sca_NotaC_Datos(ByVal Cadena As String, ByVal vOpt As String, ByVal Emp As String) As DataTable
        cmd.Connection = Conex
        cmd.CommandType = CommandType.StoredProcedure
