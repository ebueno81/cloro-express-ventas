Public Class Ent_BolAnexo
    ...
    Public Property c_nro_boleta() As String
        ...
        End Set
    End Property
    Public Property c_total_boleta() As Decimal
        Get
            Return _c_total_boleta
        End Get
        Set(ByVal value As Decimal)
            _c_total_boleta = value
        End Set
    End Property
    Public Property c_serie_anexo() As String
        ...
        End Set
    End Property
    Public Property c_boleta_anexo() As String
        Get
            Return _c_boleta_anexo
        End Get
        Set(ByVal value As String)
            _c_boleta_anexo = value
        End Set
    End Property
