...
Public Class FrmConHistoDocAnexos
    Dim c_Neg_FactCab As New Neg_FactCab
    Dim c_Neg_BolCab As New Neg_BolCab

    Private Sub FrmConHistoDocAnexos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then Me.Close()
    End Sub
    Private Sub FrmConHistoDocAnexos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    End Sub
    'Cargamos grid para facturas...
    Public Sub Cargar_Grid(ByVal Cadena As String, ByVal Cadena2 As String, ByVal Opcion As String)
        If Opcion = "FACT" Then Dgv01.DataSource = c_Neg_FactCab.get_FactCab_Datos(Cadena, "ANE", Cadena2)
        If Opcion = "FACR" Then Dgv01.DataSource = c_Neg_FactCab.get_FactCab_Datos(Cadena, "RE2", FrmMenu.TxtCod_Emp.Text)
        If Opcion = "BOL" Then Dgv01.DataSource = c_Neg_BolCab.get_BolCab_Datos(Cadena, "ANE", FrmMenu.TxtCod_Emp.Text)
    ...
    End Sub
    ' Coloreanos Registros anulados de otro color cuando  registro se encuentre anulado '
