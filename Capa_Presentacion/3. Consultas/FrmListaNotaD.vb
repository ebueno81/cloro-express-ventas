Public Class FrmListaNotaD

    Private Sub FrmListaNotaD_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Call Avanzar_Enter(e)
    End Sub
    Private Sub FrmListaNotaD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        c_Neg_MnSeries.get_Series_Cbo(" and c_anula_reg=0 and c_codi_doc='04' order by c_nro_serie", CboSerie, FrmMenu.TxtCod_Emp.Text)
    ...
    Private Sub Cargar_Grid(ByVal Cadena As String)
        With Dgv01
            .DataSource = c_Neg_NotaD.get_NotaD_Datos(Cadena, "LIS", FrmMenu.TxtCod_Emp.Text)
            ...
            .Columns("Nro.Nota D.").HeaderCell.Style.BackColor = Color.Yellow
            .Columns("Nro.Nota D.").HeaderCell.Style.ForeColor = Color.Blue
            ' Llamamos al metodo para mostrar los registros del grid '
    ...
    Private Sub BtnMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnMostrar.Click
        ...
        If Rdb03.Checked = True Then Saldo = " and N.c_imp_saldo>0 "
        If Rdb04.Checked = True Then Saldo = " and N.c_imp_saldo<=0 "
        'Facturas Anuladas...
    ...
    Private Sub TxtFactura_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtFactura.KeyDown
        If e.KeyCode = Keys.Enter Then
            If Val(TxtFactura.Text) > 0 Then
                ...
                Call Cargar_Grid(" and N.c_nro_nd='" & TxtFactura.Text & "' and N.c_nro_serie='" & CboSerie.Text & "'")
            End If
        End If
    End Sub
    ...
    Private Sub BtnOpen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOpen.Click
        ...
        If Len(Folder01.SelectedPath.ToString) > 0 Then
            If Len(Folder01.SelectedPath.ToString) = 3 Then
                TxtRuta.Text = Folder01.SelectedPath & "Listado_NotaDebito.XLS"
            Else
                TxtRuta.Text = Folder01.SelectedPath & "\Listado_NotaDebito.XLS"
            End If
        End If
    End Sub
    ' Exportamos Registros de Boleta de Debito '
    ...
    Private Sub BtnImp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnImp.Click
        Dim Titulo As String = "" : Dim Vendedor As String = ""
        Dim Saldo As String = "" : Dim Anula As String = "" : Dim Fecha As String = "" : Dim Cliente As String = ""
        'Amortizados o cancelados...
        If Rdb03.Checked = True Then
            Saldo = " and N.c_imp_saldo>0 "
            Titulo = "Listado de Nota Débito Pendientes - Amortizados DEL : " & DtpFec_Inicio.Text & " AL : " & DtpFec_Final.Text
        End If
        If Rdb04.Checked = True Then
            Saldo = " and N.c_imp_saldo<=0 "
            Titulo = "Listado de Nota Débito Canceladas DEL : " & DtpFec_Inicio.Text & " AL : " & DtpFec_Final.Text
        End If
        'Facturas Anuladas...
        If Rdb05.Checked = True Then Anula = " and N.c_anula_reg=0 "
        If Rdb06.Checked = True Then
            Anula = " and N.c_anula_reg=1 " : Saldo = " "
            Titulo = "Listado de Nota Débito Anuladas DEL : " & DtpFec_Inicio.Text & " AL : " & DtpFec_Final.Text
        End If
        If Len(TxtClie.Text) > 0 Then Cliente = " And Cl.c_desc_clie like '%" & TxtClie.Text & "%' "
        'Fecha de emision
        Fecha = " and N.c_fecha_emi>='" & DtpFec_Inicio.Text & "' and N.c_fecha_emi<='" & DtpFec_Final.Text & "' "
        ...
        If Len(CboVendedor.Text) > 0 Then Vendedor = " and Cl.c_codi_vende='" & CboVendedor.SelectedValue & "' "
        Call Cargar_Grid(Saldo & Anula & Fecha & Cliente & Vendedor)
        c_Neg_NotaD.get_NotaD_Datos(Saldo & Anula & Fecha & Cliente & Vendedor, "RPT", FrmMenu.TxtCod_Emp.Text)
        FrmReportes.Reporte_ListaDoc(Titulo, "NOTA DEBITO", TxtTot_03.Text, TxtTot_04.Text,
