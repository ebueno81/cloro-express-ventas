...
Public Class FrmMnSeriesGuia
    ...
    Private Sub BtnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGrabar.Click
        ...
        Else
            ...
            MsgBox("Falta ingresar la serie o número de guía.", vbCritical, Compañia)
    ...
    Private Sub Grabar_Series(ByVal cOpcion As String)
        ...
        Dim itemGiro As ItemGiro =
        TryCast(
            CboGiro.SelectedItem,
            ItemGiro)

        If itemGiro Is Nothing Then

            MsgBox("Debe seleccionar el giro.", vbExclamation, Compañia)
            Exit Sub
        ...
        With c_Ent_MnSeriesGuia
            ...
            .c_opc_electronico = IIf(ChkElectronico.Checked, 1, 0)

            .c_guia_interna = IIf(ChkInterno.Checked, 1, 0)

            'NUEVO
            .c_codi_giro = itemGiro.IdGiro
        ...
        MsgBox("Registro se grabó correctamente...", vbInformation, Compañia)
    ...
    Private Sub SeleccionarGiro(
    ByVal IdGiro As Integer)

        Dim i As Integer

        For i = 0 To CboGiro.Items.Count - 1
