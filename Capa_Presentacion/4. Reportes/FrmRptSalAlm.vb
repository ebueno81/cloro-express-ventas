Public Class FrmRptSalAlm
    Private Sub FrmRptSalAlm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then Pan10.Visible = False
    End Sub
    ' Avanzamos presionando la tecla enter '
    Private Sub FrmRptSalAlm_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        Call Avanzar_Enter(e)
    End Sub

    Private Sub FrmRptSalAlm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CboMt.SelectedIndex = -1 : CboMon.SelectedIndex = 0
    ...
    Private Sub Cargar_Grid(ByVal vOpt As String)
        ...
        With Dgv01
            ...
            .DataSource = c_Neg_AlmSalTADet.get_AlmSalArt_Datos(DtpFec_Inicio.Text, DateAdd("d", 1, DtpFec_Final.Text), TxtCod_Clie.Text, TxtCod_Mt.Text, TxtCod_Linea.Text,
                                                                    TxtCod_Familia.Text, TxtCod_SFamilia.Text, Txtcod_Articulo.Text, TxtSerie_Guia.Text, TxtGuia.Text,
                                                                CboMon.SelectedValue, c_opc_noingsal, CboAlm.SelectedValue, vOpt)
    ...
    Private Sub LnkImpAgrMes_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LnkImpDetalle.LinkClicked
        ...
        If ChkArtEspecial.Checked = True Then c_opc_noingsal = "0"
        FrmReportes.Close()
        FrmReportes.Reporte_Articulos_Pantallazo(Titulo, DtpFec_Inicio.Text, DateAdd("d", 1, DtpFec_Final.Text), TxtCod_Mt.Text, TxtCod_Clie.Text, TxtCod_Linea.Text, TxtCod_Familia.Text,
                                    TxtCod_SFamilia.Text, Txtcod_Articulo.Text, TxtSerie_Guia.Text, TxtGuia.Text, "TOD", TxtTot_07.Text, TxtTot_08.Text, CboMon.SelectedValue,
                                                 c_opc_noingsal, CboAlm.SelectedValue)
        Pan10.Visible = False
    End Sub
    ...
    Private Sub LnkImpAgrDia_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LnkImpAgrClie.LinkClicked
        ...
        With Dgv01
            ...
            Dim vOpt As String = "TOD"
            c_Neg_AlmSalTADet.get_AlmSalClie_Datos(DtpFec_Inicio.Text, DateAdd("d", 1, DtpFec_Final.Text), TxtCod_Clie.Text, TxtCod_Mt.Text, TxtCod_Linea.Text,
                                                                    TxtCod_Familia.Text, TxtCod_SFamilia.Text, Txtcod_Articulo.Text, TxtSerie_Guia.Text, TxtGuia.Text,
    ...
    Private Sub BtnConArt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnConArt.Click
        With FrmConArt
            ...
            .TxtVar.Text = 2 : .Txtcod_Linea.Text = TxtCod_Linea.Text : .TxtCod_Familia.Text = TxtCod_Familia.Text
            .TxtCod_Sfamilia.Text = TxtCod_SFamilia.Text
            .Cargar_Grid(" and A.c_anula_reg=0 and c_codi_linea='" & TxtCod_Linea.Text &
               "' and c_codi_familia='" & TxtCod_Familia.Text & "' and c_codi_sfamilia LIKE '%" & TxtCod_SFamilia.Text & "%' order by c_desc_articulo")
    ...
    Private Sub BtnConCd_Click(sender As System.Object, e As System.EventArgs) Handles BtnConFamilia.Click
        With FrmConFamilia
            ...
            .Txtcod_Linea.Text = TxtCod_Linea.Text : .TxtVar.Text = 2
        End With
    End Sub
